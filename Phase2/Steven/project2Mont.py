...
District = dataMontgomeryCrime['incident_type'].value_counts()
print(District)
print()
type = dict.fromkeys(dataMontgomeryCrime['incident_type']).keys()
DistrictFrame = dataMontgomeryCrime['incident_type'].isin(type)
noiseValue = len(dataMontgomeryCrime.index) - len(DistrictFrame.index)
fraction_noiseValues = noiseValue / len(dataMontgomeryCrime.index)
print('district noise fraction','\t',fraction_noiseValues)
print()
...
dataMontgomeryCrime.to_csv('dataMontgomeryCrime.csv')